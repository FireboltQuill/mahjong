...
function makeStyles(vw, vh) {
  ...
  // Achievement badges in the stats modal (spec §8.8)
  achGrid: {
  ...
  achIcon: { fontSize: s(28), lineHeight: 1, marginBottom: s(4) },
  achName: { color: gold, fontSize: ts(12), fontWeight: "bold", letterSpacing: 0.5, marginBottom: s(2) },
  achDesc: { color: green, fontSize: ts(10), lineHeight: 1.4 },
  achDate: { color: greenDim, fontSize: ts(9), marginTop: s(4), fontStyle: "italic" },
  // Achievement toast (spec §8.8 — Z_TOAST z-index above all modals)
  achToast: {
    position: "fixed", top: s(16), left: "50%", transform: "translateX(-50%)",
    background: `linear-gradient(135deg, ${gold}, #a8873d)`,
    color: bg, padding: `${s(10)}px ${s(20)}px`,
    borderRadius: s(8),
